...
if [ -b /dev/sdl ] ; then
  ...
  echo "part /boot --ondisk=sda --fstype=ext3 --size=1 --grow --asprimary --fsoptions=rw,noatime" >> /tmp/diskpart
  echo "part swap --ondisk=sdb --size=10240 --asprimary --fsoptions=rw,noatime" >> /tmp/diskpart
  echo "part / --ondisk=sdb --fstype=ext3 --size=5120 --asprimary --fsoptions=rw,noatime" >> /tmp/diskpart
  echo "part /MSTR --ondisk=sdb --fstype=ext3 --size=1 --grow --asprimary --fsoptions=rw,noatime" >> /tmp/diskpart
  echo "part /dfs01 --ondisk=sdc --fstype=ext4 --size=1 --grow --asprimary --fsoptions=rw,noatime" >> /tmp/diskpart
  echo "part /dfs02 --ondisk=sdd --fstype=ext4 --size=1 --grow --asprimary --fsoptions=rw,noatime" >> /tmp/diskpart
  echo "part /dfs03 --ondisk=sde --fstype=ext4 --size=1 --grow --asprimary --fsoptions=rw,noatime" >> /tmp/diskpart
  echo "part /dfs04 --ondisk=sdf --fstype=ext4 --size=1 --grow --asprimary --fsoptions=rw,noatime" >> /tmp/diskpart
  echo "part /dfs05 --ondisk=sdg --fstype=ext4 --size=1 --grow --asprimary --fsoptions=rw,noatime" >> /tmp/diskpart
  echo "part /dfs06 --ondisk=sdh --fstype=ext4 --size=1 --grow --asprimary --fsoptions=rw,noatime" >> /tmp/diskpart
  echo "part /dfs07 --ondisk=sdi --fstype=ext4 --size=1 --grow --asprimary --fsoptions=rw,noatime" >> /tmp/diskpart
  echo "part /dfs08 --ondisk=sdj --fstype=ext4 --size=1 --grow --asprimary --fsoptions=rw,noatime" >> /tmp/diskpart
  echo "part /dfs09 --ondisk=sdk --fstype=ext4 --size=1 --grow --asprimary --fsoptions=rw,noatime" >> /tmp/diskpart
  echo "part /dfs10 --ondisk=sdl --fstype=ext4 --size=1 --grow --asprimary --fsoptions=rw,noatime" >> /tmp/diskpart
elif [ -b /dev/sdb ] ; then
  ...
  echo "part /boot --ondisk=sda --fstype=ext3 --size=100 --asprimary --fsoptions=rw,noatime" >> /tmp/diskpart
  echo "part swap --ondisk=sda --size=10240 --asprimary --fsoptions=rw,noatime" >> /tmp/diskpart
  echo "part / --ondisk=sda --fstype=ext3 --size=5120 --asprimary --fsoptions=rw,noatime" >> /tmp/diskpart
  echo "part /MSTR --ondisk=sda --fstype=ext3 --size=1 --grow --asprimary --fsoptions=rw,noatime" >> /tmp/diskpart
fi
...
/tmp/OpenManage/linux/supportscripts/srvadmin-install.sh -d -s -r -w -a
rm -rf /tmp/OpenManage
rm /root/OM-SrvAdmin-Dell-Web-LX-6.5.0-2247.RHEL5.x86_64_A01.4.tar.gz
